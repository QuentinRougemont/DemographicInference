...
def usage():
    ...
    print("# This script allow you to test different demographic models on your genomic data\n"+
        ...
        "# -o pathoutput -y population1 -p 10,20,30 -f pathfsfile -m SI,SI2N,SIG,SI2NG,EM,IM,IMG,IM2N,IM2N2m,IM2NG,IM2mG,AM,AMG,AM2N,AM2N2m,AM2NG,AM2mG,AM2N2mG,PAM,SC,SC2N,SCG,SC2N2m,SC2NG,SC2mG,SC2N2mG,PSC,EM2M,IM2m,AM2m,SC2m,EM2M2P,IM2M2P,AM2M2P,PAM2M2P,SC2M2P,PSC2M2P -l -a -h -v\n\n"+
...
def takearg(argv):
    ...
    model_list = ["SI","SI2N","SIG", "SI2NG","PAN","PANG","PANGb"]
    verbose = False
    logparam = False
    nompop1 = "Pop1"
    #nompop2 = "Pop2"
