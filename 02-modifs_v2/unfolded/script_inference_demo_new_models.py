...
def usage():
	...
	print("# This script allow you to test different demographic models on your genomic data\n"+
	      ...
	      "# -o pathoutput -y population1 -x population2 -p 10,20,30 -f pathfsfile -m SI,SI2N,SIG,SI2NG,EM,IM,IMG,IM2N,IM2NG,IM2mG,IM2N2m,IM2N2mG,AM,AMG,AM2N,AM2N2m,AM2NG,AM2mG,AM2N2mG,PAM,SC,SC2N,SCG,SC2N2m,SC2NG,SC2mG,SC2N2mG,PSC,EM2M,IM2m,AM2m,SC2m,EM2M2P,IM2M2P,AM2M2P,PAM2M2P,SC2M2P,PSC2M2P -l -a -h -v\n\n"+
	      ...
	      "# -m --model_list : Take until 18 name of model (SI,SI2N,SIG,SI2NG,EM,IM,IMG,IM2N,IM2NG,IM2mG,IM2N2m,IM2N2mG,AM,AMG,AM2N,AM2N2m,AM2NG,AM2mG,AM2N2mG,PAM,SC,SC2N,SCG,SC2N2m,SC2NG,SC2mG,SC2N2mG,PSC,EM2M,IM2m,AM2m,SC2m,EM2M2P,IM2M2P,AM2M2P,PAM2M2P,SC2M2P,PSC2M2P) separated by a coma.\n"+
...
def takearg(argv):
	...
	model_list = ["SI", "SI2N", "SIG", "SI2NG", "IM", "IMG", "IM2N", "IM2NG", "IM2mG", "IM2N2m","IM2N2mG","AM", "AMG", "AM2N","AM2N2m", "AM2NG", "AM2mG", "AM2N2mG", "SC", "SC2N", "SCG" , "SC2N2m", "SC2NG", "SC2mG", "SC2N2mG", "IM2m", "AM2m", "SC2m"]
	verbose = False
	logparam = False
	nompop1 = "Pop1"
	nompop2 = "Pop2"
...
for namemodel in model_list:
	...
	if namemodel == "IM2N2m":
		...
		func = modeledemo_mis_new_models.IM2N2m
	...
	if namemodel == "IM2N2mG":
		...
		# Custom Ancient Migration with 2 Migration rate model:  nu1, nu2, b1, b2, hrf, m12, m21, me12, me21, Ts, P, Q, O
		func = modeledemo_mis_new_models.IM2N2mG
